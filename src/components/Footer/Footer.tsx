    ...
    return (
        <footer  className=" lg:flex lg:items-start items-start p-10 flex-col lg:flex-row text-white items-" >
            <section className="lg:w-1/3 p-10 lg:p-5  flex  flex-col justify-center items-center gap-10 ">
                ...
                <img  className="w-fit h-fit p-10  max-h-96 justify-center align-middle items-center " src="https://i.ibb.co/CMpS6Pr/logo2.png" alt="Estoria" />
                <h2 className="text-center text-8xl samkaran">Estoria</h2>
